defmodule EmoteTest do
  ...
  describe "convert_mapping_to_emoji" do
    test "should return emoji when called correctly", do: assert convert_word(":face_with_ok_gesture:") == "🙆"
    test "should return original text when emoji not found", do: assert convert_word(":not_yet_existent_emoji:") == ":not_yet_existent_emoji:"
  end
